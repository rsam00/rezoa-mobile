...
const styles = StyleSheet.create({
  ...
  scrollContent: { padding: 20, paddingTop: 80, paddingBottom: 100 },
  stationBanner: { marginBottom: 15, alignItems: 'center' },
  ...
  label: { color: '#71717a', fontSize: 11, fontWeight: '900', letterSpacing: 1.5, marginBottom: 4 },
  input: { backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 8, padding: 10, color: '#fff', fontSize: 14, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)' },
  textArea: { height: 80, textAlignVertical: 'top' },
  scheduleSlot: { backgroundColor: 'rgba(255,255,255,0.03)', borderRadius: 12, padding: 10, marginBottom: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)' },
  ...
  timeRow: { flexDirection: 'row', gap: 15, marginBottom: 10 },
  timeInputContainer: { flex: 1 },
  timeLabel: { color: '#52525b', fontSize: 9, fontWeight: '900', marginBottom: 4 },
  timeInput: { backgroundColor: 'rgba(0,0,0,0.3)', borderRadius: 6, padding: 8, color: '#fff', fontSize: 14, textAlign: 'center', borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)' },
  daysRow: { flexDirection: 'row', justifyContent: 'space-between' },
  dayButton: { width: 32, height: 32, borderRadius: 16, backgroundColor: 'rgba(255,255,255,0.05)', justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)' },
  dayButtonActive: { backgroundColor: '#a78bfa', borderColor: '#a78bfa' },
  dayText: { color: '#71717a', fontSize: 12, fontWeight: '700' },
  dayTextActive: { color: '#000' },
  mainSubmitButton: { height: 48, borderRadius: 16, overflow: 'hidden', justifyContent: 'center', alignItems: 'center', marginTop: 10 },
